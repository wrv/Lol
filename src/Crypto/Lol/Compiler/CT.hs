...
addPublicCT :: (AddPublicCtx t m m' zp zq, CTOps :<: dom', dom ~ Typed dom', Show (Cyc t m zp), Typeable (CT m zp (Cyc t m' zq))) 
  => Cyc t m zp -> ASTF dom (CT m zp (Cyc t m' zq)) -> ASTF dom (CT m zp (Cyc t m' zq))
addPublicCT c = (injT (AddPublic c) :$)

mulPublicCT :: (MulPublicCtx t m m' zp zq, CTOps :<: dom', dom ~ Typed dom', Show (Cyc t m zp), Typeable (CT m zp (Cyc t m' zq))) 
  => Cyc t m zp -> ASTF dom (CT m zp (Cyc t m' zq)) -> ASTF dom (CT m zp (Cyc t m' zq))
